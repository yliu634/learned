...
//   Model model;
 ...
 public:
  KapilLinearHashTable() = default;

  /**
   * Constructs a KapilLinearHashTable given a list of keys
  ...
  class Iterator {
    ...
    const KapilLinearHashTable& hashtable;
   ...
   public:
    ...
    friend class KapilLinearHashTable;
  };
